    ...
    <body class="teal">
        ...
        <div id="login-page" class="row">
                ...
                <form class="login-form" action="<?php echo e(route('post_login')); ?>" method="post" onsubmit="return load()">
                    ...
                    <div class="row">
                        <div class="input-field col s12 center">
                            <p class="center login-form-text" style="font-size:23px;margin-top:5px">RS CIKMED</p>
            ...
            <div class="row center-align white-text" style="margin-bottom:0">
                <span>Powered by <a href="http://www.justlabtech.com" target="_blank" style="color:#ccc">IT SUPPORT RS CIKMED</a></span>
            </div>
        </div>
