...
<html>
    <head>
        ...
        <title><?php echo $__env->yieldContent('title'); ?> | RS CIKMED</title>
    ...
    <body>
            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li><h1 class="logo-wrapper"><a href="<?php echo e(route('dashboard')); ?>" class="brand-logo darken-1"><img src="<?php echo e(asset('assets/images/jltoken-logo.png')); ?>" alt="materialize logo"></a><span class="logo-text">RS CIKMED</span></h1></li>
                        </ul>
        ...
        <footer class="page-footer">
            <div class="footer-copyright">
                <div class="container">
                    <span>Powered by : <a class="grey-text text-lighten-3" href="http://www.justlabtech.com" target="_blank">IT SUPPORT RS CIKMED 2020</a> All rights reserved.</span>
